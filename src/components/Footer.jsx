            ...
            <div className='desktop'>
                <div className='footer-links-table'>
                    <div className='footer-links'>
                        ...
                        <ul>
                            <li>
                                <a href="/about-us/our-history" className="link">Our History</a>
                            </li>
                            <li>
                                <a href="/about-us/corporate-profile" className="link">Corporate Profile</a>
                            </li>
                            <li>
                                <a href="/about-us/corporate-governance" className="link">Corporate Governance</a>
                            </li>
                            <li>
                                <a href="/about-us/board-management-team" className="link">Board and Management Team</a>
                            </li>
                            <li>
                                <a href="/about-us/corporate-philosophy" className="link">Corporate Philosophy</a>
                            </li>
                            <li>
                                <a href="/about-us/our-awards" className="link">Our Awards</a>
                            </li>
                            <li>
                                <a href="/about-us/our-businesses" className="link">Our Businesses</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='footer-links'>
                        ...
                        <ul>
                            <li>
                                <a href="/careers/working-at-access-bank" className="link">Working At Access Bank</a>
                            </li>
                            <li>
                                <a href="/careers/your-career" className="link">Your Career</a>
                            </li>
                            <li>
                                <a href="/careers/recruitment-process" className="link">Recruitment Process</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='footer-links'>
                        <h2 className='title'>YOU ARE...</h2>
                        <ul>
                            <li>
                                <a href="/personal/everyday-accounts/individual-current-account" className="link">An Individual</a>
                            </li>
                            <li>
                                <a href="/careers" className="link">A Job Applicant</a>
                            </li>
                            <li>
                                <a href="https://thewcommunity.com" className="link">A Woman</a>
                            </li>
                            <li>
                                <a href="/corporate/corporate-sector" className="link">A Company</a>
                            </li>
                            <li>
                                <a href="/media" className="link">A Journalist</a>
                            </li>
                            <li>
                                <a href="/personal/kids-teens" className="link">A Teenager</a>
                            </li>
                            <li>
                                <a href="/business/emerging-business" className="link">An Entrepreneur</a>
                            </li>
                            <li>
            ...
            <div className='social-links'>
                ...
                <div className='right-text'>
                    <div className='social-icons'>
                        ...
                        <div className='icons'>
                            <a href="https://twitter.com/MyAccessBank" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
                                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"></path>
                                </svg>
                            </a>

                            <a href="https://www.facebook.com/AccessBankPlc" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"></path>
                                </svg>
                            </a>

                            <a href="https://www.instagram.com/myaccessbank/" target="_blank">
                            ...
                            <a href="https://www.linkedin.com/company/access-bank-plc/" target="_blank">
